(function($) {    
    $.fn.fbuilder = function(options){
        ...
        var showSettings= {
            ...
            showName: function(v) {
                return '<label>Field Name</label><input class="large" name="sName" id="sName" value="'+v+'" />';
            },
        ...
        $.extend(fnumber.prototype,ffields.prototype,{
                ...
                show:function(){
                    return '<div class="fields" id="field-'+this.index+'"><label>'+this.title+''+((this.required)?"*":"")+'</label><div class="dfield"><input id="'+this.name+'" name="'+this.name+'" min='+this.min+' max='+this.max+' class="field number '+this.size+((this.required)?" required":"")+'" type="text" value="'+this.predefined+'"/></div><div class="clearer"></div></div>';    
                },
        ...
        $.extend(fcheck.prototype,ffields.prototype,{ 
                ...
                layout:"one_column",
                required:false,
                choices:new Array("First Choice","Second Choice","Third Choice"),
                choiceSelected:new Array(false,false,false),
                display:function(){
                    var str = "";
