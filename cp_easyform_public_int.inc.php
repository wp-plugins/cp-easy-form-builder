...
<form class="cpp_form" name="cp_easyform_pform<?php echo $CP_EFB_global_form_count; ?>" id="cp_easyform_pform<?php echo $CP_EFB_global_form_count; ?>" action="<?php cp_easyform_get_site_url(); ?>" method="post" enctype="multipart/form-data" onsubmit="return cp_easyform_pform_doValidate<?php echo $CP_EFB_global_form_count; ?>(this);"><input type="hidden" name="cp_pform_psequence" value="<?php echo $CP_EFB_global_form_count; ?>" /><input type="hidden" name="cp_easyform_pform_process" value="1" /><input type="hidden" name="cp_easyform_id" value="<?php echo $id; ?>" /><input type="hidden" name="cp_ref_page" value="<?php esc_attr(cp_easyform_get_site_url()); ?>" /><input type="hidden" name="form_structure<?php echo $CP_EFB_global_form_count; ?>" id="form_structure<?php echo $CP_EFB_global_form_count; ?>" size="180" value="<?php echo str_replace("\r","",str_replace("\n","",esc_attr(cp_easyform_cleanJSON(cp_easyform_get_option('form_structure', CP_EASYFORM_DEFAULT_form_structure,$id))))); ?>" />
<div id="fbuilder">
